...
const LatestNews = () => {
  ...
  return (
    <div
      ...
      <div className='lg:w-[9.43%] w-fit px-2 bg-yellow py-4 text-center font-semibold text-white ring-1 ring-white'>
        <p className='font-sans'>Latest News</p>
      </div>
      <div className='flex-1 py-4 text-center bg-[#1EB3A6] flex justify-between items-center font-bangla'>
        <marquee>
